        ...
        <div className="col card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <span className="fs-6 fw-bold">Developer:</span>{" "}
              {vg?.developer || "Loading..."}
            </p>
            <p className="card-text">
              <span className="fs-6 fw-bold">Publisher:</span>{" "}
              {vg?.publisher || "Loading..."}
            </p>
            <p className="card-text">
              <span className="fs-6 fw-bold">Release Date:</span>{" "}
              {vg?.publicationDate || "Loading..."}
            </p>
            <div className="card-text">
              <span className="fs-6 fw-bold">This game also exists on:</span>
